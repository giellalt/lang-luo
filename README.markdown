...
This directory contains source files for the Luo (Kenya and Tanzania)
...
-   <https://giellalt.uit.no/lang/luo/index.xml> (analyser)
-   <https://giellalt.uit.no/index.html> (infrastructure)

Requirements
============

In order to compile and use Luo (Kenya and Tanzania) language morphology
...
The Luo (Kenya and Tanzania) language sources can be acquired using
[giella SVN
