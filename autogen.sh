...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_luo to login script."
...
# the current dir:
if   test x${GTLANG_luo} = x ; then
	echo "WARNING: The variable \${GTLANG_luo} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_luo} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_luo} has the value:"
	echo "  ${GTLANG_luo}"
